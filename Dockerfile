...
RUN ./home/elasticsearch/bin/plugin --install license
RUN ./home/elasticsearch/bin/plugin --install marvel-agent
RUN ./home/kibana/bin/kibana plugin --install elasticsearch/marvel/latest
RUN ./home/kibana/bin/kibana plugin --install elastic/sense 
